...
?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>HELIX POS</center></font>
<div id="mainmain">
...
<a href="cart.php"><i class="icon-group icon-2x"></i><br> Add to cart</a>      
